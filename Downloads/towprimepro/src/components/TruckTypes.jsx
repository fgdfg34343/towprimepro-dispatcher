      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {truckTypes.map((t, i) => (
            <div
              key={t.id}
              className={`group bg-white border border-slate-100 rounded-3xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 card-3d flex flex-col ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
